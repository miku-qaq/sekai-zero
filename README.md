...
Mikureina 长期维护、持续迭代的动漫主题个人网站。首页以明亮的「白昼动画杂志」作为世界入口，用个人简介、当前学习、世界地图、三位喜欢的角色频道与次元扭蛋帮助访客快速认识 Mikureina；详细内容沿「关于我、动画收藏、学习笔记、链接、日志」五条清晰路线展开。动画收藏馆忠实整理 Mikureina 提供的已看片单，并为封面保留可追溯来源。重点不是堆砌功能，而是建立稳定的工程地基、鲜明但克制的视觉系统，以及可以安全扩展的内容边界。
...
2. 身份、文案、动画清单、学习内容和链接收藏优先修改 `content/`；每一话统一登记在 `content/releases.ts`，当前学习与兴趣信号维护在 `content/now.ts`，页面组合放在 `app/`。
...
动漫角色相关内容只使用自制、生成、获得授权或有明确资料来源的素材，并记录来源。当前主视觉采用原创角色群像，以色彩和人物原型回应站点兴趣，不复制官方立绘、官方服装或 Logo；动画收藏封面来自已核对的公开作品条目，版权仍归各作品权利方。完整登记见 `docs/ASSETS.md`。公开个人资料、联系方式和统计能力必须经过站点所有者确认。
