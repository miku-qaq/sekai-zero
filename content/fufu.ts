export type FufuCollectionEntry = {
  ...
  character: "初音未来";
  kind: "large" | "zodiac";
  zodiac: "寅" | "卯" | "辰" | "巳" | "午" | null;
  year: 2022 | 2023 | 2024 | 2025 | 2026 | null;
  motif: string;
...
export const fufuCollection: readonly FufuCollectionEntry[] = [
  ...
  },
  {
    ...
    title: "初音ミク　巳2025　ふわぷち　ぬいぐるみ（LL）",
    character: "初音未来",
    kind: "zodiac",
    zodiac: "巳",
    year: 2025,
...
export const fufuCollectionMeta = {
  ...
  summary:
    "单独记录我的初音未来 Fufu 毛绒：从寅 2022 生肖款开始连续收藏到午 2026，也把原先记录在手办区的大 Fufu 迁回这里。",
