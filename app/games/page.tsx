...
export const metadata: Metadata = {
  title: "游戏收藏馆",
  description:
    "Mikureina 的游戏收藏馆：整理 Steam 本地记录中的实际游玩作品，并为 Nintendo Switch 收藏保留可继续补充的空间。",
};
    ...
    <main id="main-content" className={`subpage-main ${styles.gamesPage}`}>
      ...
      >
        <div className="section-heading horizontal-heading">
          <div>
            <p className="section-index">01 / STEAM PLAYED ARCHIVE</p>
            <h2 id="game-archive-title">从游戏库里找回旅程。</h2>
          </div>
          <p>
            按 Steam
            当前显示的作品名整理，可直接搜索。这里不是时长榜或推荐榜，只记录这台设备上确认过的游玩足迹。
          </p>
        </div>

        <CollectionSwitch current="games" />
      ...
      <JourneyNavigation currentHref="/games/" />
      <SiteFooter />
    </main>
  );
}
